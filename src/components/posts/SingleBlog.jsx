    ...
    <>
      <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16 relative">
        ...
        <div className="max-w-screen-xl mx-auto my-5">
          <div className="top-content my-4 flex flex-col gap-4 md:flex-row md:justify-between md:items-center">
              ...
              <div className="flex flex-col">
                <Link href={`/authors/${authorId}`}>
                  <Typography variant="h6">
                    {blogData?.author || <Spinner />}
                  </Typography>
                </Link>
                <Typography
                  variant="small"
                  color="gray"
                  className="font-normal flex flex-row gap-1 items-center justify-center md:text-sm text-xs"
                >
                  <sapn className="whitespace-nowrap">
                    {blogData?.timestamp
                      ? `Posted ${timeAgo(blogData.timestamp)}`
                      : "Posted - ago"}
                  </sapn>
                  <BsDot />
                  {blogData?.categories || <Spinner />}
                </Typography>
              </div>
            </div>
